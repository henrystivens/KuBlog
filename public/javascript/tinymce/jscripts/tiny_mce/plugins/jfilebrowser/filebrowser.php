...
if (!isset($cookie_vbrw) || $set_cook == 1) {
    ...
    if (isset($_GET['busqueda']))
        header('Location: filebrowser.php?seccion=1&busqueda=' . $busqueda);
    elseif (isset($_GET['id']))
        header('Location: filebrowser.php?seccion=1&id=' . $id);
}
elseif ($set_cook == 2) {
    //setear el cookie
...
<?php echo $mensaje_err; ?>
                        ...
                        switch ($seccion) {
                            ...
                            case 1: {
                                    ...
                                    //configuraci�n de la paginacion
                        ...
                        ?>
                                    <div class="contain_men_cat">
                                        <ul class="menu_cat">
                                            <li><a href="filebrowser.php?seccion=1&amp;<?php
                                    if ($busq_act)
                                        echo "busqueda=$busqueda"; else
                                        echo "id=$id" ?>&amp;set_c=1" class="thumbnail_a<?php if ($cookie_vbrw == 1)
                                            echo '_activo' ?>">Thumbnals</a></li>
                                     <li><a href="filebrowser.php?seccion=1&amp;<?php
                                            if ($busq_act)
                                                echo "busqueda=$busqueda"; else
                                                echo "id=$id" ?>&amp;set_c=2" class="lista_a<?php if ($cookie_vbrw == 2)
                                                    echo '_activo' ?>">Lista</a></li>
<?php if (!$busq_act) { ?>
                        ...
                        ?>
                                                <ul class="imag_list_ul<?php if ($cookie_vbrw == 2)
                                                            echo '_lista' ?>">
                                <?php
...
<?php } ?>
                            ...
                            ?>
                                                      <li><div>
                                                              <form id="form_submit<?php if ($cookie_vbrw == 2)
                                                                        echo '_lista' ?>" method="post" action="" class="centrar_2" onsubmit="jFileBrowserDialog.confirmar('estas seguro que quieres borrar esta imagen', <?php echo $cuenta_form ?>);return false">
                                                                      <input type="image" name="borrar_cat_bt" id="borrar_cat_bt" src="img/delete.png" />
                                                                      <input name="validacion" type="hidden" id="validacion2" value="4" />
                                                                      <input name="id" type="hidden" id="id" value="<?php echo $result_categorias_img['id_archivos'] ?>" />
                                                                                </form>
...
<?php } ?>
                        ...
                        <?php
                                                                ...
                                                                echo 'no se encontr&oacute; ning&uacute;n archivo';
                                                        }
                                                        break;
                                                    //subir imagen
                                                    case 2: {
...
<?php while ($row_rs_producto2 = mysql_fetch_assoc($rs_producto2)) { ?>
                                                            <option value="<?php echo $row_rs_producto2['cat_id_cat'] ?>" <?php if ($cat == $row_rs_producto2['cat_id_cat'])
                                                                        echo 'selected="selected"' ?>><?php echo $row_rs_producto2['name_cat'] ?></option>
<?php } ?>
                                                                    </select>
<?php } ?>              </td>
                                                        </tr>
                        ...
                        ?>
                            ...
                            ?>
                                                                        <li>
                                                                            ...
                                                                            <span class="info_cat_sp"><a href="filebrowser.php?seccion=1&amp;id=<?php echo $id_cat ?>"<?php if ($num_img > 0)
                                                                            echo ' class="cat_con_img"'; ?>><?php echo $result_categorias_img['name_cat'] ?></a> (<?php echo $num_img ?>)</span>
                                                                        </li>
<?php ++$cuenta_form;
                                                                    } ?>
                                                                    </ul>
